...
| Variable | Label | Description | Survey Question | Response Categories | Rationale |
|:---|:---|:---|:---|:---|:---|
| `POVCAT23` | Family Income | Family income relative to poverty line | Derived from detailed income components and family size | Poor, Near Poor, Low, Middle, High | Determines subsidy eligibility and insurance quality. [[4]](#ref4) |
...
2. **Family Income Range:** "What is your family's total annual income from all sources?" (Approximates the MEPS aggregation of wages, business, and other income; aligns with the MEPS experimental "show card" method used for early estimates).
