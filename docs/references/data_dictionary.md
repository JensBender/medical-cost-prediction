...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **DUPERSID** | PERSON ID (DUID + PID) | ID | Str | Unique ID | **Primary Key.** Unique identifier for each person. |
| **DUID** | DWELLING UNIT ID | ID | Int | 30001–68884 | Identifies the dwelling unit (household). |
| **PID** | PERSON NUMBER | ID | Int | 101–503 | Identifies person within the dwelling unit. |
| **PANEL** | PANEL NUMBER | Nominal | Int | 27, 28 | Panel number associated with the round. |
...
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **POVCAT23** | FAMILY INCOME AS % OF POVERTY LINE | Ordinal | Int | 1=Poor/Negative, 2=Near Poor, 3=Low Income, 4=Middle Income, 5=High Income | Derived variable. Usually no missing codes. |
| **FAMSZE23** | TOTAL NUMBER OF PERSONS IN FAMILY | Numerical | Int | 1–14 | Count of related persons in the reporting unit. |
| **HIDEG** | HIGHEST DEGREE WHEN FIRST ENTERED | Ordinal | Int | 1=No Degree, 2=GED, 3=HS Diploma, 4=Bachelor's, 5=Master's, 6=Doctorate, 7=Other, 8=Under 16 | Highest degree attained. Codes -1, -7, -8, -9 apply. 8 is Under 16. |
| **EMPST31** | EMPLOYMENT STATUS - R3/1 | Nominal | Int | 1=Employed, 2=Job to return to, 3=Job during ref period, 4=Not employed | Status at beginning of year. Codes -1, -7, -8, -9 apply. |

## 5. Insurance & Access
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **INSCOV23** | HEALTH INSURANCE COVERAGE INDICATOR | Nominal | Int | 1=Any Private, 2=Public Only, 3=Uninsured | Summary coverage status for 2023. No missing codes. |
| **HAVEUS42** | AC05 DOES PERSON HAVE USC PROVIDER | Binary | Int | 1=Yes, 2=No | Has a usual source of care. Codes -1, -7, -8, -9 apply. |

## 6. Perceived Health & Lifestyle
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **RTHLTH31** | PERCEIVED HEALTH STATUS - RD 3/1 | Numerical | Int | 1=Excellent, 2=Very Good, 3=Good, 4=Fair, 5=Poor | Codes -1, -7, -8, -9 apply. |
| **MNHLTH31** | PERCEIVED MENTAL HEALTH - RD 3/1 | Numerical | Int | 1=Excellent, 2=Very Good, 3=Good, 4=Fair, 5=Poor | Codes -1, -7, -8, -9 apply. |
| **ADSMOK42** | CURRENTLY SMOKE (>17) | Binary | Int | 1=Yes, 2=No | Asked of adults 18+. Codes -1, -7, -8, -9 apply. |

## 7. Limitations & Symptoms
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **ADLHLP31** | ADL HELP - RD 3/1 | Binary | Int | 1=Yes, 2=No | Needs help with personal care. Codes -1, -7, -8, -9 apply. |
| **IADLHP31** | IADL HELP - RD 3/1 | Binary | Int | 1=Yes, 2=No | Needs help with routine needs. Codes -1, -7, -8, -9 apply. |
| **WLKLIM31** | LIMITATION IN PHYSICAL FUNCTIONING | Binary | Int | 1=Yes, 2=No | Difficulty walking/climbing stairs. Codes -1, -7, -8, -9 apply. |
| **COGLIM31** | COGNITIVE LIMITATIONS | Binary | Int | 1=Yes, 2=No | Confusion/memory loss. Codes -1, -7, -8, -9 apply. |
| **JTPAIN31_M18**| JOINT PAIN LAST 12 MONTHS (>17) | Binary | Int | 1=Yes, 2=No | Pain/stiffness in joints. Codes -1, -7, -8, -9 apply. |
...
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **HIBPDX** | HIGH BLOOD PRESSURE DIAG (>17) | Binary | Int | 1=Yes, 2=No | Codes -1, -7, -8, -9 apply. |
| **CHOLDX** | HIGH CHOLESTEROL DIAGNOSIS (>17) | Binary | Int | 1=Yes, 2=No | Codes -1, -7, -8, -9 apply. |
| **DIABDX_M18**| DIABETES DIAGNOSIS | Binary | Int | 1=Yes, 2=No | Asked for all ages. Codes -1, -7, -8, -9 apply. |
| **CHDDX** | CORONARY HEART DISEASE DIAG (>17) | Binary | Int | 1=Yes, 2=No | Codes -1, -7, -8, -9 apply. |
| **STRKDX** | STROKE DIAGNOSIS (>17) | Binary | Int | 1=Yes, 2=No | Codes -1, -7, -8, -9 apply. |
...
| Variable | Label | Semantic Type | Storage Type | Values | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **TOTSLF23** | TOTAL AMT PAID BY SELF/FAMILY 23 | Numerical | Float | $0.00 – $176,550.00 | **Target Variable.** Out-of-pocket costs paid by patient/family. |
| **TOTEXP23** | TOTAL HEALTH CARE EXP 23 | Numerical | Float | $0.00 – $2,301,675.00 | Total cost across all payers (insurance, public, self). |
