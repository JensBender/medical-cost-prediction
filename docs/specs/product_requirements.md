...
| **UI-03** | **Comparison Benchmarks** | Bar chart comparing user vs. national and age group benchmarks. Use "typical" in the main text and define it in a short note below the chart. | `gr.Plot` | "Typical American: $248 vs. Typical for ages 45–54: $244"<br><small>Typical means the median cost: half of people spent less, and half spent more.</small> |
