...
- **Infographics**: The [MEPS data infographic](./assets/data_infographic.jpg) and [US healthcare costs infographic](./assets/healthcare_costs_guide.png) were generated using [Gemini 3 Pro Image](https://deepmind.google/models/gemini-image/pro/) via the [Gemini app](https://gemini.google.com/app) by Google.
