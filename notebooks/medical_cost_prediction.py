...
#     <ul style="margin-top:10px; margin-bottom:0px">
#         <li><b>Clinical Profile:</b> Outliers are characterized by "High Comorbidity," typically suffering from 4x more medical conditions than inliers (median 4 vs. 1). Chronic diseases (HTN, Diabetes, Arthritis) and functional limitations (e.g., 75% walking limitation) are significantly more prevalent.</li>
...
#     - **Handling Outliers:** Detected univariate outliers with 3SD and 1.5 IQR methods and identified multivariate outliers with an isolation forest. Profiled outliers by comparing out-of-pocket costs and feature distributions between inliers and outliers. Confirmed that outliers represent legitimate legitimate "High Comorbidity" health profiles rather than data errors, and retained all outliers to preserve the model's ability to predict extreme out-of-pocket costs.
