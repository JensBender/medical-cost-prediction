...
#             </ul>
#         </li>
#         <li style="margin-bottom:10px;"><b>2. Train-Validation-Test Split</b>
#             <ul style="margin-top:5px;">
...
#             </ul>
#         </li>
#         <li style="margin-bottom:10px;"><b>3. Feature Engineering</b>
#             <ul style="margin-top:5px;">
...
#                 <li style="margin-bottom:5px;"><b>Tree-Based Models (XGBoost, RF):</b> Tree models are natively robust to non-linearities and don't require log-transformed targets. However, to prevent their splits from being overwhelmingly governed by the extreme high-cost tail, shift their objective functions from standard MSE to an <b>Absolute Error (MAE)</b> criterion (e.g., <code>reg:absoluteerror</code> in XGBoost) to directly align the training loss with our MdAE metric. Alternatively, leverage XGBoost's <code>reg:tweedie</code> objective, which is mathematically designed for zero-inflated, highly skewed datasets.</li>
#                 <li><b>Distance-Based (KNN) & Gradient-Based (MLP) Models:</b> Unlike tree models, KNN and MLP are highly sensitive to unscaled variance. They mandate both robust feature standardization and <b>log-transformed costs</b> to prevent "super-spenders" from destroying Euclidean distance calculations and destabilizing gradient backpropagation.</li>
#             </ul>
#         </li>
