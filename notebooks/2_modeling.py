...
#         <li><b>MVP Monitoring Scope:</b> Track aggregate app health, completion rate, input drift, and prediction drift without storing user-level input rows or prediction records. For prediction drift, monitor the aggregate distribution of predicted q50, q25-q75 range width, q90 safety cushion, high-uncertainty flags, and missingness rates; broad input slices such as insurance status, poverty category, mental health, and chronic-condition count can help explain distribution shifts.</li>
