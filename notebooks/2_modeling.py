...
#         <li><strong>Subgroup Reliability:</strong> Physical health, chronic conditions, private insurance, and public insurance groups remain within diagnostic coverage bands. Uninsured users are the main coverage watchlist group: typical-range coverage is low at 34.7%, while safety-cushion coverage is conservative at 96.3%. The safety cushion is not under-warning, but the typical range may be too narrow or shifted for uninsured users and should be monitored after launch.</li>
