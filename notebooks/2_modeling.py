...
#     Stratified error analysis for quantile regression evaluates not only the middle estimate, but also prediction ranges and safety cushion by group. Reuse the same target-based and feature-based groups as before.
#     <ul style="margin-top:8px">
