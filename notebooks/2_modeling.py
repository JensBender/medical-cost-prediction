...
# %% [markdown]
# <div style="background-color:#fff6e4; padding:15px; border-width:3px; border-color:#f5ecda; border-style:solid; border-radius:6px">
#     📌 Load the Stage 2 results generated by <code>scripts/benchmark_shap.py</code> and display the decision table for the shortlisted candidates.
# </div>
...
display(
    ...
    .pipe(add_table_caption, "SHAP Benchmarking Stage 2: Shortlist Results")
    .format({
        "Background vs. Training Difference": "{:.1%}",
        "First-Call Latency": "{:.2f} s",
        "P50 Latency": "{:.2f} s",
